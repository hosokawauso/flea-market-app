  ...
  <div class="profile__inner">
    <form class="profile-form__form" action="/mypage/profile" method="post" enctype="multipart/form-data">
      ...
      <div class="profile-img">
        ...
        @endif
          <input hidden type="file" id="profile_img" name="profile_img" accept="image/*" >
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const placeholder = "{{ asset('img/default.png') }}";
  ...
  input.addEventListener('change', (changeEvent) => {
    ...
    reader.onload = (readEvent) => {
      ...
      preview.src = (typeof result === 'string' && result.length) ? result :
      placeholder;
      preview.hidden = false;
      if (button) button.style.display = '';
    };
