...
<div class="purchase-address">
  ...
  <div class="purchase-address__inner">
    <form class="purchase-address-form__form" action="/purchase" method="post" >
      @csrf
      <div class="purchase-address-form__group">
        <label class="purchase-address-form__label" for="postal_code">郵便番号</label>
        <input class="purchase-address-form__input" type="text" name="postal_code" id="postal_code" inputmode="numeric"  value="{{ old('postal_code', $user->postal_code) }}">
      ...
      <div class="purchase-address-form__group">
        ...
        <input class="purchase-address-form__input" type="text" name="address" id="address" value="{{ old('address', $user->address) }}">
        <p class="purchase-address-form__error-message">
          @error('address')
          {{ $message }}
          @enderror
      ...
      <div class="purchase-address-form__group">
        ...
        <input class="purchase-address-form__input" type="text" name="building" id="building" value="{{ old('building', $user->building) }}">
      </div>
